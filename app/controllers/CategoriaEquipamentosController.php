...
class CategoriaEquipamentosController extends BaseController {

	protected $categoria;

	public function __construct(CategoriaEquipamentos $categoria)
    {
        parent::__construct();
    ...
    public function index()
    {
        ...
        return View::make('categorias_equip.index')
            ->with(array(
                'descricao' => Input::get('descricao'),
    ...
    {
        return View::make('categorias_equip.create');
    }
    ...
    public function store()
    {
        ...
        if($validator->fails()) {
            ...
            return Redirect::to('categorias_equip')
    ...
    public function edit($id)
    {
        try {
            ...
            return View::make('categorias_equip.edit')
                ->with(array(
                    'categoria' => $categoria
                ));
