...
class LocalizacaoEquipamentosController extends BaseController {

	protected $localizacao;

	public function __construct(LocalizacaoEquipamentos $localizacao)
    {
        parent::__construct();
    ...
    public function index()
    {
        ...
        return View::make('localizacoes.index')
            ->with(array(
                'descricao' => Input::get('descricao'),
    ...
    {
        return View::make('localizacoes.create');
    }
    ...
    public function store()
    {
        ...
        if($validator->fails()) {
            ...
            return Redirect::to('localizacao')
    ...
    public function edit($id)
    {
        try {
            ...
            return View::make('localizacoes.edit')
                ->with(array(
