...
@section('content')
	<h4>
		<span class="glyphicon glyphicon-edit"></span> Alterar categorias de materiais
		<a href="{{ URL::to('categorias_mat') }}" class="btn btn-info navbar-right"><span class="glyphicon glyphicon-chevron-left"></span> Voltar</a>
	</h4>
	<hr>
	{{Form::open(array('url' => 'categorias_mat/'. $categoria->id, 'method' => 'put', 'class' => 'form-horizontal row', 'role' => 'form'))}}
