	...
	{{ Form::open(array('url' => 'funcionario', 'class' => 'form-horizontal row', 'role' => 'form')) }}
		...
		<div class="col-md-2 {{ $errors->first('data_nascimento') ? 'has-error' : '' }}">
			...
			<div class="input-group date">
	        	{{ Form::text('data_nascimento', Input::old('data_nascimento'), array('data-mask' => '99/99/9999', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-md-2 {{ $errors->first('data_admissao') ? 'has-error' : '' }}">
			...
			<div class="input-group date">
	        	{{ Form::text('data_admissao', Input::old('data_admissao'), array('data-mask' => '99/99/9999', 'class' => 'form-control', 'required')) }}
	        	<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
	        </div>
		...
		<div class="col-md-3 {{ $errors->first('naturalidade') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('naturalidade', Input::old('naturalidade'), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-2 {{ $errors->first('uf_natural') ? 'has-error' : '' }}">
			...
			{{ Form::select('uf_natural', Util::estados(), Input::old('uf_natural'), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-3 {{ $errors->first('nacionalidade') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('nacionalidade', Input::old('nacionalidade'), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-3 {{ $errors->first('cpf') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('cpf', Input::old('cpf'), array('data-mask' => '999.999.999-99', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-md-1 {{ $errors->first('numero') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('numero', Input::old('numero'), array('data-mask' => '9999', 'class' => 'form-control')) }}
		...
		<div class="col-md-3 {{ $errors->first('jornada_id') ? 'has-error' : '' }}">
        	...
        	{{ Form::select('jornada_id', JornadaTrabalho::options(), Input::old('jornada_id'), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-3 {{ $errors->first('funcao_id') ? 'has-error' : '' }}">
        	...
        	{{ Form::select('funcao_id', Funcao::options(), Input::old('funcao_id'), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-2 {{ $errors->first('data_demissao') ? 'has-error' : '' }}">
			...
			<div class="input-group date">
	        	{{ Form::text('data_demissao', Input::old('data_demissao'), array('data-mask' => '99/99/9999', 'class' => 'form-control')) }}
	        	<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
	        </div>
