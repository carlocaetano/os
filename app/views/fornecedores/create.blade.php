...
@section('content')
	<h4>
		<span class="glyphicon glyphicon-plus-sign"></span> Adicionar novo fornecedor
		<a href="{{ URL::to('fornecedor') }}" class="btn btn-info navbar-right"><span class="glyphicon glyphicon-chevron-left"></span> Voltar</a>
	</h4>
	<hr>
	{{ Form::open(array('url' => 'fornecedor', 'class' => 'form-horizontal row', 'role' => 'form')) }}

		<div class="col-md-5 {{ $errors->first('nome_razao_social') ? 'has-error' : '' }}">
			{{ Form::label('nome_razao_social', '* Nome/Razão Social', array('class' => 'control-label')) }}
        	{{ Form::text('nome_razao_social', Input::old('nome_razao_social'), array('class' => 'form-control input-md', 'required')) }}
        	{{ $errors->first('nome_razao_social', '<span class="text-danger">:message</span>') }}
		</div>
		...
		<div class="col-md-5 {{ $errors->first('apelido_nome_fantasia') ? 'has-error' : '' }}">
			{{ Form::label('apelido_nome_fantasia', '* Apelido/Nome fantasia', array('class' => 'control-label')) }}
        	{{ Form::text('apelido_nome_fantasia', Input::old('apelido_nome_fantasia'), array('class' => 'form-control', 'required')) }}
        	{{ $errors->first('apelido_nome_fantasia', '<span class="text-danger">:message</span>') }}
		</div>
