...
@section('content')
	<h4>
		<span class="glyphicon glyphicon-edit"></span> Alterar cliente
		<a href="{{ URL::to('cliente') }}" class="btn btn-info navbar-right"><span class="glyphicon glyphicon-chevron-left"></span> Voltar</a>
	</h4>
	<hr>
	{{ Form::open(array('url' => 'cliente/' . $cliente->id, 'method' => 'put', 'class' => 'form-horizontal row', 'role' => 'form')) }}
		...
		<div class="col-md-5 {{ $errors->first('razao_social') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('razao_social', Input::old('razao_social', $cliente->razao_social), array('class' => 'form-control input-md', 'required')) }}
		...
		<div class="col-md-3 {{ $errors->first('data_cadastro') ? 'has-error' : '' }}">
			...
			<div class="input-group date">
	        	{{ Form::text('data_cadastro', Input::old('data_cadastro', Util::toView($cliente->data_cadastro)), array('data-mask' => '99/99/9999', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-md-2 {{ $errors->first('tp_pessoa') ? 'has-error' : '' }}">
			...
			{{ Form::radio('tp_pessoa', 'F', (Input::old('tp_pessoa', $cliente->tp_pessoa) == 'F') ? true : false,  array('id'=>'F')) . ' ' . Form::label('tp_pessoa', 'Física') . '&nbsp;&nbsp;' }}
			{{ Form::radio('tp_pessoa', 'J', (Input::old('tp_pessoa', $cliente->tp_pessoa) == 'J') ? true : false,  array('id'=>'J')) . ' ' . Form::label('tp_pessoa', 'Jurídica')  }}

		</div>
		
		<div class="col-md-1 {{ ($cliente->ativo == '1') ? 'borda_situacao_ativo' : 'borda_situacao_inativo' }}">
			{{ Form::label('ativo', '* Situação', array('class' => 'control-label'))}} <br/><br/>
			
			{{ Form::checkbox('ativo', $cliente->ativo,
			($cliente->ativo == '1') ? true : false, array('id' => 'ativo')) . ' ' .
			Form::label('ativo', (Input::old('ativo', $cliente->ativo) == '1') ? 'Ativo' : 'Inativo') }}
		</div>
		...
		<div class="col-md-5 {{ $errors->first('nome_fantasia') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('nome_fantasia', Input::old('nome_fantasia', $cliente->nome_fantasia), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-3 {{ $errors->first('cnpj') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('cnpj', Input::old('cnpj', $cliente->cnpj), array('data-mask' => '99.999.999/9999-99', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-md-3 {{ $errors->first('cpf') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('cpf', Input::old('cpf', $cliente->cpf), array('data-mask' => '999.999.999-99', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-md-3 {{ $errors->first('data_nascimento') ? 'has-error' : '' }}">
			...
			<div class="input-group date">
	        	{{ Form::text('data_nascimento', Input::old('data_nascimento', Util::toView($cliente->data_nascimento)), array('data-mask' => '99/99/9999', 'class' => 'form-control', 'required')) }}
	        	<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
	        </div>
		...
		<div class="col-md-3 {{ $errors->first('inscricao_est_rg') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('inscricao_est_rg', Input::old('inscricao_est_rg', $cliente->inscricao_est_rg), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-2 {{ $errors->first('orgao_exp_rg') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('orgao_exp_rg', Input::old('orgao_exp_rg', $cliente->orgao_exp_rg), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-3 {{ $errors->first('data_exped_rg') ? 'has-error' : '' }}">
			...
			<div class="input-group date">
	        	{{ Form::text('data_exped_rg', Input::old('data_exped_rg', Util::toView($cliente->data_exped_rg)), array('data-mask' => '99/99/9999', 'class' => 'form-control', 'required')) }}
	        	<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
	        </div>
		...
		<div class="col-md-5 {{ $errors->first('endereco') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('endereco', Input::old('endereco', $cliente->endereco), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-1 {{ $errors->first('numero') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('numero', Input::old('numero', $cliente->numero), array('data-mask' => '9999', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-md-5 {{ $errors->first('complemento') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('complemento', Input::old('complemento', $cliente->complemento), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-4 {{ $errors->first('bairro') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('bairro', Input::old('bairro', $cliente->bairro), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-3 {{ $errors->first('cidade') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('cidade', Input::old('cidade', $cliente->cidade), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-2 {{ $errors->first('uf') ? 'has-error' : '' }}">
			...
			{{ Form::select('uf', Util::estados(), Input::old('uf', $cliente->uf), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-2 {{ $errors->first('cep') ? 'has-error' : '' }}">
		    ...
		    {{ Form::text('cep', Input::old('cep', $cliente->cep), array('data-mask' => '99.999-999', 'class' => 'form-control', 'required')) }}
		...
		<div class="col-md-5 {{ $errors->first('ponto_referencia') ? 'has-error' : '' }}">
        	...
        	{{ Form::text('ponto_referencia', Input::old('ponto_referencia', $cliente->ponto_referencia), array('class' => 'form-control', 'required')) }}
		...
		<div class="col-md-2 {{ $errors->first('tel_1') ? 'has-error' : '' }}">
		    ...
		    {{ Form::text('tel_1', Input::old('tel_1', $cliente->tel_1), array('data-mask' => '(99) 9999-9999', 'class' => 'form-control')) }}
		...
		<div class="col-md-2 {{ $errors->first('tel_2') ? 'has-error' : '' }}">
		    ...
		    {{ Form::text('tel_2', Input::old('tel_2', $cliente->tel_2), array('data-mask' => '(99) 9999-9999', 'class' => 'form-control')) }}
		...
		<div class="col-md-2 {{ $errors->first('tel_3') ? 'has-error' : '' }}">
		    ...
		    {{ Form::text('tel_3', Input::old('tel_3', $cliente->tel_3), array('data-mask' => '(99) 9999-9999', 'class' => 'form-control')) }}
		...
		<div class="col-md-3 {{ $errors->first('celular1') ? 'has-error' : '' }}">
		    ...
		    {{ Form::text('celular1', Input::old('celular1', $cliente->celular1), array('data-mask' => '(99) 9-9999-9999', 'class' => 'form-control')) }}
		...
		<div class="col-md-3 {{ $errors->first('celular2') ? 'has-error' : '' }}">
		    ...
		    {{ Form::text('celular2', Input::old('celular2', $cliente->celular2), array('data-mask' => '(99) 9-9999-9999', 'class' => 'form-control')) }}
		    {{ $errors->first('celular2', '<span class="text-danger">:message</span>') }}
		</div>

		<div class="col-md-5 {{ $errors->first('email') ? 'has-error' : '' }}">
			{{ Form::label('email', 'E-mail', array('class' => 'control-label')) }}
        	{{ Form::text('email', Input::old('email', $cliente->email), array('class' => 'form-control')) }}
		...
		<div class="col-md-11 pull-left {{ $errors->first('observacao') ? 'has-error' : '' }}">
        	...
        	{{ Form::textarea('observacao', Input::old('observacao', $cliente->observacao), array('class' => 'form-control')) }}
