...
@section('content')
	<h4>
		<span class="glyphicon glyphicon-edit"></span> Alterar localização de equipamentos
		<a href="{{ URL::to('localizacao') }}" class="btn btn-info navbar-right"><span class="glyphicon glyphicon-chevron-left"></span> Voltar</a>
	</h4>
	<hr>
	{{Form::open(array('url' => 'localizacao/'. $localizacao->id, 'method' => 'put', 'class' => 'form-horizontal row', 'role' => 'form'))}}
