...
@section('content')
	<h4>
		<span class="glyphicon glyphicon-plus-sign"></span> Adicionar nova localização de equipamentos
		<a href="{{ URL::to('localizacao') }}" class="btn btn-info navbar-right"><span class="glyphicon glyphicon-chevron-left"></span> Voltar</a>
	</h4>
	<hr>
	{{Form::open(array('url' => 'localizacao', 'class' => 'form-horizontal row', 'role' => 'form'))}}
