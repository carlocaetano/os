...
@section('content')
	<h4>
		<span class="glyphicon glyphicon-plus-sign"></span> Adicionar nova categoria de equipamentos
		<a href="{{ URL::to('categorias_equip') }}" class="btn btn-info navbar-right"><span class="glyphicon glyphicon-chevron-left"></span> Voltar</a>
	</h4>
	<hr>
	{{Form::open(array('url' => 'categorias_equip', 'class' => 'form-horizontal row', 'role' => 'form'))}}
